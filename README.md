<p align="center">
  <img src="android/app/src/main/res/drawable-nodpi/warpscout_cloud.png" width="200" alt="Облако WarpScout">
</p>

<h1 align="center">WarpScout for Android</h1>

<p align="center">Локальное сканирование WARP-адресов и работа с конфигурациями на Android.</p>
...
<p align="center"><strong><a href="README_EN.md">English version</a></strong></p>
...
- Выбор лучшего адреса по пингу или скорости, перебор открытых или всех известных портов и своя цель пинга внутри туннеля
- Поиск AWG junk и I1
- Поиск MASQUE SNI
- Сканирование WARP-in-WARP
- Локальная история сканирований
- Отображение, копирование и повторное применение всех параметров завершённого сканирования
